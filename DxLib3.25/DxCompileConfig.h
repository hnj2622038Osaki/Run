...
#if defined( DX_GCC_COMPILE ) || defined( __ANDROID__ ) || defined( __APPLE__ ) || defined( BC2_COMPILER ) || defined( __PROSPERO__ )
	#define USE_ULL
#endif
...
#if defined( __psp2__ ) || defined( __ORBIS ) || defined( __PROSPERO__ )
	#ifndef DX_NON_INLINE_ASM
		#define DX_NON_INLINE_ASM
	#endif
#endif // defined( __psp2__ ) || defined( __ORBIS ) || defined( __PROSPERO__ )
